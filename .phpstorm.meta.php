...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'Honeystone\Seo\Contracts\BuildsMetadata' => \Honeystone\Seo\MetadataDirector::class,
            'Honeystone\Seo\Contracts\RegistersGenerators' => \Honeystone\Seo\Registry::class,
    ...
    override(\config(), map([
            ...
            'domain.directories' => 'array',
            'domain.base_namespaces' => 'array',
            ...
            'filesystems.disks.pdfs.driver' => 'string',
            'filesystems.disks.pdfs.root' => 'string',
            'filesystems.disks.pdfs.serve' => 'boolean',
            'filesystems.disks.pdfs.throw' => 'boolean',
            'filesystems.disks.pdfs.report' => 'boolean',
            'filesystems.disks.pdfs.url' => 'string',
            'filesystems.disks.resume_pdfs.driver' => 'string',
            'filesystems.disks.resume_pdfs.root' => 'string',
            'filesystems.disks.resume_pdfs.serve' => 'boolean',
            'filesystems.disks.resume_pdfs.throw' => 'boolean',
            'filesystems.disks.resume_pdfs.report' => 'boolean',
            'filesystems.disks.resume_pdfs.url' => 'string',
            'filesystems.disks.og.driver' => 'string',
            'filesystems.disks.og.root' => 'string',
            'filesystems.disks.og.serve' => 'boolean',
            'filesystems.disks.og.throw' => 'boolean',
            'filesystems.disks.og.report' => 'boolean',
            'filesystems.disks.og.url' => 'string',
            'filesystems.disks.og_images.driver' => 'string',
            'filesystems.disks.og_images.root' => 'string',
            'filesystems.disks.og_images.serve' => 'boolean',
            'filesystems.disks.og_images.throw' => 'boolean',
            'filesystems.disks.og_images.report' => 'boolean',
            'filesystems.disks.og_images.url' => 'string',
            'filesystems.links.C:\laragon\www\projects\victorgutt\victorgutt.dev\public\storage' => 'string',
            ...
            'services.github.access_token' => 'string',
            'services.pirsch.token' => 'string',
            ...
            'ziggy.except' => 'array',
            'ziggy.skip-route-function' => 'boolean',
            'ziggy.output.path' => 'string',
            'ziggy.output.file' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.title' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.titleTemplate' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.description' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.keywords' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.canonicalEnabled' => 'boolean',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.canonical' => 'NULL',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.robots' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\MetaGenerator.custom' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.enabled' => 'boolean',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.site' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.card' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.creator' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.creatorId' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.title' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.description' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.image' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\TwitterGenerator.imageAlt' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.enabled' => 'boolean',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.site' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.type' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.title' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.description' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.images' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.audio' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.videos' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.determiner' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.url' => 'NULL',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.locale' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.alternateLocales' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\OpenGraphGenerator.custom' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.enabled' => 'boolean',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.pretty' => 'boolean',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.type' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.name' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.description' => 'string',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.images' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.url' => 'NULL',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.custom' => 'array',
            'honeystone-seo.generators.Honeystone\Seo\Generators\JsonLdGenerator.place-on-graph' => 'boolean',
            'honeystone-seo.sync.url-canonical' => 'boolean',
            'honeystone-seo.sync.keywords-tags' => 'boolean',
...
'app.aliases.Vite','app.supported_locales','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'database.redis.cache.username','database.redis.cache.password','database.redis.cache.port','database.redis.cache.database','domain.directories',
'domain.base_namespaces','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.serve',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.disks.pdfs.driver','filesystems.disks.pdfs.root',
'filesystems.disks.pdfs.serve','filesystems.disks.pdfs.throw','filesystems.disks.pdfs.report','filesystems.disks.pdfs.url','filesystems.disks.resume_pdfs.driver',
'filesystems.disks.resume_pdfs.root','filesystems.disks.resume_pdfs.serve','filesystems.disks.resume_pdfs.throw','filesystems.disks.resume_pdfs.report','filesystems.disks.resume_pdfs.url',
'filesystems.disks.og.driver','filesystems.disks.og.root','filesystems.disks.og.serve','filesystems.disks.og.throw','filesystems.disks.og.report',
'filesystems.disks.og.url','filesystems.disks.og_images.driver','filesystems.disks.og_images.root','filesystems.disks.og_images.serve','filesystems.disks.og_images.throw',
'filesystems.disks.og_images.report','filesystems.disks.og_images.url','filesystems.links.C:\\laragon\\www\\projects\\victorgutt\\victorgutt.dev\\public\\storage','hashing.driver','hashing.bcrypt.rounds',
...
'ide-helper.macroable_traits','inertia.ssr.enabled','inertia.ssr.url','inertia.ssr.bundle','inertia.testing.ensure_pages_exist',
...
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.github.access_token','services.pirsch.token',
...
'session.partitioned','view.paths','view.compiled','ziggy.except','ziggy.skip-route-function',
'ziggy.output.path','ziggy.output.file','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.title','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.titleTemplate','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.description',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.keywords','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.canonicalEnabled','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.canonical','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.robots','honeystone-seo.generators.Honeystone\\Seo\\Generators\\MetaGenerator.custom',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.enabled','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.site','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.card','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.creator','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.creatorId',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.title','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.description','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.image','honeystone-seo.generators.Honeystone\\Seo\\Generators\\TwitterGenerator.imageAlt','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.enabled',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.site','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.type','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.title','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.description','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.images',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.audio','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.videos','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.determiner','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.url','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.locale',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.alternateLocales','honeystone-seo.generators.Honeystone\\Seo\\Generators\\OpenGraphGenerator.custom','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.enabled','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.pretty','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.type',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.name','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.description','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.images','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.url','honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.custom',
'honeystone-seo.generators.Honeystone\\Seo\\Generators\\JsonLdGenerator.place-on-graph','honeystone-seo.sync.url-canonical','honeystone-seo.sync.keywords-tags','tinker.commands','tinker.alias',
'tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api',);
        registerArgumentsSet('routes', 
'redirect:resume.without_locale.fr','redirect:resume.without_locale.en','redirect:resume.with_locale.en','redirect:resume.with_locale.fr','web:home',
'web:projects','web:open_source.index','web:open_source.show','web:tech_stack','web:contact',
'web:resume.en','web:resume.fr','web:visit.initial','web:visit.nojs','web:',
'dev:colors','dev:og','storage.local','storage.pdfs','storage.resume_pdfs',
'storage.og','storage.og_images',);
        registerArgumentsSet('views', 
'app','honeystone-seo::json-ld','honeystone-seo::layout','honeystone-seo::meta','honeystone-seo::meta.custom',
'honeystone-seo::open-graph','honeystone-seo::open-graph.audio','honeystone-seo::open-graph.custom','honeystone-seo::open-graph.image','honeystone-seo::open-graph.type',
'honeystone-seo::open-graph.types.article','honeystone-seo::open-graph.types.book','honeystone-seo::open-graph.types.profile','honeystone-seo::open-graph.video','honeystone-seo::twitter',
'honeystone-seo::twitter.card','honeystone-seo::twitter.cards.app','honeystone-seo::twitter.cards.player','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'actions.view','actions.view_all','actions.yes','http-statuses.0','http-statuses.100',
...
'http-statuses.unknownError','languages.en.label','languages.fr.label','locations.corsica','locations.france',
'misc.page.untranslated.to_french','page_links.projects.label','page_links.projects.label_short','page_links.open_source.label','page_links.open_source.label_short',
'page_links.tech_stack.label','page_links.tech_stack.label_short','page_links.contact.label','page_links.contact.label_short','contact.0',
'home.0','oss.0','project.0','resume.0','tech_stack.0',
'socials.follow.on','symbols.@','symbols..','terms.social_networks','terms.web_developer',
'terms.web_designer','words.light','words.dark','words.resume','words.email',
'words.since','fr.0',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'DB_CONNECTION','MAIL_MAILER','MAIL_SCHEME','MAIL_HOST','MAIL_PORT',
'MAIL_USERNAME','MAIL_PASSWORD','MAIL_FROM_ADDRESS','MAIL_FROM_NAME','VITE_APP_NAME',
'VITE_APP_URL','GITHUB_ACCESS_TOKEN','PIRSCH_TOKEN',);
